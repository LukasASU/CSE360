...
public class ControllerFirstAdmin {
	...
	*/
	...
	protected static void doSetupAdmin(Stage ps, int r) {
		...
		String usernameError = applicationMain.UserNameRecognizer.checkForValidUserName(adminUsername);
		if (usernameError != null && !usernameError.isEmpty()) {
		    ViewFirstAdmin.label_PasswordsDoNotMatch.setText(usernameError);
		    return;
		}
		
		//implementing my new password checker
		String passwordError = ModelFirstAdmin.evaluatePassword(adminPassword1);
